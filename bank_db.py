...
transfer_sql = 'CREATE TABLE tranfers(transfer_ID INT AUTO_INCREMENT PRIMARY KEY, \
	from_acct_ID INT, to_acct_ID INT, amount FLOAT, transfer_date DATETIME)'
my_cursor.execute(transfer_sql)
